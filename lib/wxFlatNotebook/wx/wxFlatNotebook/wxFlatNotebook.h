...
public:
    ...
    */
    ...
    // Setters / Getters
    void SetForceSelection(bool force)
    {
        m_bForceSelection = force;
    }
    bool GetForceSelection()
    {
        return m_bForceSelection;
    }
    wxWindowPtrArray& GetWindows()
    {
        return m_windows;
    }
    wxPageContainer *GetPages()
    {
        return m_pages;
    }
...
public:
    ...
    */
    void SetCaption(wxString value)
    {
        m_strCaption = value;
    }
    ...
    */
    void SetTabAngle(unsigned int value)
    {
        m_TabAngle = FNB_MIN((unsigned int)(45), (unsigned int)(value));
    }

    /// Returns an inclination of tab header borders
    unsigned int GetTabAngle()
    {
        return m_TabAngle;
    }
    ...
    */
    void SetRegion(const size_t n, const wxPoint points[])
    {
        m_region = wxRegion(n, points);
    }
    ...
    */
    void SetXRect(const wxRect& xrect)
    {
        m_xRect = xrect;
    }
...
public:
    ...
    */
    ...
    Image list assigned with this method will not be deleted by wxFlatNotebook's destructor, you must delete it yourself.
    */
    virtual void SetImageList(wxFlatNotebookImageList * imglist)
    {
        m_ImageList = imglist;
    }

    /// Returns an image list object associated with wxFlatNotebook
    virtual wxFlatNotebookImageList * GetImageList()
    {
        return m_ImageList;
    }
    ...
    */
    ...
    \param page - page index
    */
    virtual wxString GetPageText(size_t page)
    {
        return m_pagesInfoVec[page].GetCaption();
    }
    ...
    */
    ...
    {
        m_pagesInfoVec[page].SetCaption(text);
        return true;
    }
    ...
    */
    wxPageInfoArray& GetPageInfoVector()
    {
        return m_pagesInfoVec;
    }
    ...
    */
    const wxColour&  GetGradientColourFrom() const
    {
        return m_colorFrom;
    }
    ...
    */
    const wxColour&  GetGradientColourTo() const
    {
        return m_colorTo;
    }
    /**
    ...
    * \return non active tab's text colour
    */
    const wxColour&  GetNonoActiveTextColor() const
    {
        return m_nonActiveTextColor;
    }
     ...
     * \return tab colour
     */
    const wxColour&  GetActiveTabColour() const
    {
